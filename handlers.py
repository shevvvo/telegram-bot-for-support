...
class FilterAwesome(MessageFilter):
    def filter(self, message):
        return message.from_user.id != TELEGRAM_SUPPORT_CHAT_ID
...
def setup_dispatcher(dp):
    myFilter = FilterAwesome()
    dp.add_handler(CommandHandler('start', start))
    dp.add_handler(MessageHandler(Filters.chat_type.private & myFilter, forward_to_chat))
